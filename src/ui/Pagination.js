            ...
            {currentData.map((item, i) => {
                ...
                return(<Box key={i}>
                    <HStack>
                        ...
                        <Image src={`https://res.cloudinary.com/hsdvgholu/${item.image}`} boxSize={['4em', '5em', '10em']} onClick={() => navigate(`/product/${item.product}&${item.index}`)} alt={`Wishlist ${item.name} ${item.producttype}`}/>
        ...
        return(<Card w='18rem' m='2'>
            ...
            <CardHeader p='1'>
                <HStack>
                    ...
                    <Image boxSize={['3.25em']} src={`https://res.cloudinary.com/hsdvgholu/${review.variant.image}`} alt={`Review ${review.variant.name} ${review.variant.producttype}`}/>
        ...
        return(<Card w='18rem' m='2'>
            ...
            <CardHeader p='1'>
                <HStack>
                    ...
                    <Image boxSize={['3.25em']} src={`https://res.cloudinary.com/hsdvgholu/${review.variant.image}`} alt={`Account Review ${review.variant.name} ${review.variant.producttype}`}/>
                    <Text textOverflow='ellipsis'>{review.variant.name}</Text>
                </HStack>
                <Divider/>
            </CardHeader>
